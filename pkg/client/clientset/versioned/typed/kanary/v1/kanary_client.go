...
import (
	...
	"github.com/etiennecoutaud/kanary/pkg/client/clientset/versioned/scheme"
...
func (c *KanaryV1Client) Kanaries(namespace string) KanaryInterface {
	return newKanaries(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*KanaryV1Client, error) {
	...
	return &KanaryV1Client{client}, nil
}

// NewForConfigOrDie creates a new KanaryV1Client for the given config and
...
func New(c rest.Interface) *KanaryV1Client {
	return &KanaryV1Client{c}
}
